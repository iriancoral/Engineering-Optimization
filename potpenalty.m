...
n_iter    = 7;         % number of penalty iterations
...
fprintf('  g2 (drainage)  = %.4e\n',            g_final(2));
fprintf('  g3 (stability) = %.4e\n',            g_final(3));
...
% Optimization path
plot(x_history(1,:)*1000, x_history(2,:)*1000, 'r-o', 'LineWidth', 1.5, ...
    'MarkerFaceColor', 'r', 'DisplayName', 'Penalty path');
plot(x_start(1)*1000, x_start(2)*1000, 'gs', 'MarkerSize', 10, 'MarkerFaceColor', 'g', ...
    'DisplayName', 'Start');
plot(x_pen(1)*1000, x_pen(2)*1000, 'r*', 'MarkerSize', 14, 'LineWidth', 2, ...
